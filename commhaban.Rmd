...
column(12, 
       ...
       # select a year
       column(width = 4, 
         selectInput('yrmlt', 'Select a year for comparison:', sort(unique(mlthbdat$Year)), selected = 2017)
       ),
...
column(12, 
      ...
      column(width = 4, 
             selectInput("habty", label = 'Choose habitat type to evaluate:', choices = c('run', 'riffle', 'pool'), selected  = 'riffle')
      ),
