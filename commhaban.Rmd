...
1) How does the chosen method of analysis affect the results (i.e., how robust are the conclusions with changes in the methods)?
...
renderPlot({
  ...
  pord <- ggord(ccaord, grp_in = grpin, vec_ext = 4, col = colsub, ptslab = T, parse = T,
