...
Select the year range and size density class to evaluate trends at each site.  Trends are shown as the magnitude and direction of the change between the selected years. 
