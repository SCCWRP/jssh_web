...
```{r mapviewshed, out.width="100%", context = "setup"}
...
```{r densbox, fig.height = 7, fig.width = 6, context = "setup"}
toplo <- fishdat
...
```{r denstile, fig.height = 4, fig.width = 7, context = "setup"}
