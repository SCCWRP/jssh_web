...
Select the year range and size density class to evaluate trends at each site.  Trends are shown as the magnitude and direction of the change between the selected years.  Note that not all sites include data in the full range of selected years.  Click an individual site to see the years within the selected range. 
...
=======
    mapview(mapdatst(), zcol = 'trend', cex = "tau", col.regions = cols, legend = T, homebutton = F, 
            label = mapdatst()$SiteID,
            layerId = mapdatst()$SiteID) 
>>>>>>> 131f896e350df80866f3d3192436c366d4c8a3fd
...
callModule(selectMod, 'eview', mapoutst()@map)
ns <<- shiny::NS('eview')
selectModUI('eview')
```
