...
<br>
Summary of global (left) and selected (right) linear model testing `r renderText({input$hbv})` by year interaction, `r renderText({input$shd})` watershed, `r renderText({input$typ})` habitats.
...
<br>
Summary of global (left) and selected (right) linear model testing `r renderText({input$hbv})` by year interaction.
