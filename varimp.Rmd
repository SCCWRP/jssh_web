...
<br>
Summary of all models, by `r renderText({input$shd})` watershed, `r renderText({input$typ})` habitats, and S1 size class.  Only models where variables selected were other than or in addition to year.
